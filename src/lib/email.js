...
import { generateInvoicePDFBase64 } from './invoicePdfFormal';
 ...
 * @param {string} orderData.discountCode - Discount code applied
...
export async function sendOrderConfirmationEmail(orderData) {
  try {
            ...
            <div class="wrapper">
              ...
              <div class="content">
                ...
                <div class="summary-table">
                  ...
                  ${discountAmount > 0 ? `<div class="summary-row" style="color: #4CAF50;">
    ...
    try {
      const pdfData = {
        ...
        items: items.map(item => {
          ...
          return {
            ...
            variantSize: item.size || item.variantSize,
      ...
      console.log('[PDF] Generating invoice with data:', JSON.stringify(pdfData, null, 2));
      ...
      console.log('[RESEND] Generated PDF invoice for attachment');
    } catch (pdfError) {
      console.error('[RESEND] PDF generation failed:', pdfError);
